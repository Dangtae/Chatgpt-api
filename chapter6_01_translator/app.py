...
openai.api_key = "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"
...
if st.button("번역"):
    ...
    tranlated_text = translate_text_using_chatgpt(text, src_lang, trg_lang)
    st.success(tranlated_text)